...
class EEGSEPDataset(PhysicalDataset):
    """Dataset for the EEGSEP numerical example, copied and adjsuted from the Lorenz data set
    """
    def embed_data(self, h5_file: h5py.File, embedder: EmbeddingModel) -> None:
        """Embeds EEGSEP data into a 1D vector representation for the transformer.
