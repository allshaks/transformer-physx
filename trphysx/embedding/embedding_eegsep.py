...
# !!! right now: just copy of the lorenz_embedding file
class EEGSEPEmbedding(EmbeddingModel):
    """Embedding Koopman model for the EEGSEP ODE system

    Args:
        config (PhysConfig): Configuration class with transformer/embedding parameters
    """
    model_name = "embedding_EEGSEP"
...
class EEGSEPEmbeddingTrainer(EmbeddingTrainingHead):
    """Training head for the EEGSEP embedding model
    ...
    def __init__(self, config: PhysConfig):
        ...
        """
        super().__init__()
        self.embedding_model = EEGSEPEmbedding(config)
