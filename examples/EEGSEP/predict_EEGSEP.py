# taken and adjustd based on Lorenz predict file
...
from trphysx.data_utils.dataset_EEGSEP import EEGSEPPredictDataset
...
if __name__ == "__main__":
    ...
    sys.argv = sys.argv + ["--embedding_file_or_path", "././data/u_leng_software/git/transformer-physx/outputs/embedding_EEGSEP/ntrain2048_epochs300_batch512/checkpoints/embedding_EEGSEP300.pth"] #embedding file for EEGSEP? 
    ...
    eval_dataset = EEGSEPPredictDataset(
        embedding_model,
