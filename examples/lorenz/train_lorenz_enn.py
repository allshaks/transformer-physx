...
if __name__ == '__main__':
    ...
    sys.argv = sys.argv + ["--training_h5_file", "./data/transformer_physx/lorenz_training_rk.hdf5"]
    sys.argv = sys.argv + ["--eval_h5_file", "./data/transformer_physx/lorenz_valid_rk.hdf5"]
